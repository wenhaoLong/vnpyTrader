...
class BaseGateway(ABC):
    ...
    * on_contract
    ...
    def on_event(self, type: str, data: Any = None, priority: int = 5):
        """
        General event push.
        """
    ...
    def on_tick(self, tick: TickData):
        ...
        """
        self.on_event(EVENT_TICK, tick, 10)
        self.on_event(EVENT_TICK + tick.vt_symbol, tick, 10)
    ...
    def on_order(self, order: OrderData):
        ...
        """
        self.on_event(EVENT_ORDER, order, 10)
        self.on_event(EVENT_ORDER + order.vt_orderid, order, 10)
